  ...
  steps: [
    {
      ...
      ageRange: [20, 83],
      text: V(
        [tagged("spec_coastal_retreat")],
        "沿海旧居进入分期迁居范围。评估员量完墙高，又问家里谁需要就近照护。",
        [C("resources.wealth", "lte", 42)],
        "连续高温或积水使租约变短，房东不再承诺下一季。你先找能住的地方，再计算通勤和学校要怎样接上。",
        "气候风险第一次写进住房合同。你在是否迁居一栏停了很久，楼下已经有人打包。",
      ),
      effects: [add("resources.wealth", -8), add("resources.happiness", -5), add("location.migratedTimes", 1)],
    },
    {
      ...
      text: V(
        [C("resources.wealth", "lte", 42)],
        "搬到风险较低但租金尚能承担的住处后，常去的市场和办事窗口都远了。每月住得稳一点，每天在路上多出一段。",
        [C("meta.age", "gte", 65)],
        "新社区地势更高，常去的医院和老友却留在原处。你把来回班车时刻写在门后。",
        "新住处避开主要风险，旧市场、亲友和常走的路仍在原来的方向。搬家完成了，生活关系没有一起装箱。",
      ),
      effects: [add("resources.health", 3), add("resources.freedom", -4), add("relationships.friendship", -3)],
    },
    {
      id: "second_hometown",
      title: "新地方慢慢长出第二套熟悉",
