...
export const historicalProvinceAliases = [
  ...
  },
  {
    ...
    startYear: 1840,
    endYear: 1906,
    note: "清代东北以盛京将军辖区为核心，1907 年奉天建省。首版按辽宁计算。",
  },
  {
    code: "fengtian",
    name: "奉天",
  ...
  },
  {
    ...
    startYear: 1840,
    endYear: 1927,
    note: "上海 1927 年设特别市。此前在江苏口径下，首版按历史人口/辖区粗略权重随机到江苏或上海。",
  },
  {
    code: "gansu_old",
    name: "甘肃",
  ...
  },
  {
    ...
    startYear: 1840,
    endYear: 1894,
    note: "1885 年台湾建省；此前属福建台湾府等旧行政口径。首版统一按台湾计算。",
  },
  {
  ...
  { code: "xinjiang_qing", name: "新疆地区", currentCode: "xinjiang", startYear: 1840, endYear: 1911, note: "1884 年新疆建省；此前沿用新疆地区口径。首版统一按新疆计算。" },
  {
    code: "chahar",
    name: "察哈尔",
    currentCode: "hebei",
